...
![객체 리터럴 사용 시 프로토타입 체인](./ObjectLiteralPrototypeChaining.png)
...
![생성자 함수로 생성된 객체의 프로토타입 체인](./ConstructorFunctionPrototypeChaining.png)
...
![프로토타입 객체 확장](./ExtensionPrototype.png)
